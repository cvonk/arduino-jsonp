/* webserverst.ino - demonstrates jsfiddle exchanging data with Arduino server
 *
...
struct tRGB  {
	...
	{ "b", 20, 9 }  // Blue    LED pin via 68 Ohm to Digital output 9 on Arduino
};
...
void setup()
{
	...
	delay(50);  // allow some time (50 ms) after power-up and sketch start, for the Wiznet W5100 Reset IC to release and come out of reset.
